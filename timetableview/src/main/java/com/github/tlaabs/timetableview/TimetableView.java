...
import static com.github.tlaabs.timetableview.R.styleable.TimetableView_header_highlight_type;
...
public class TimetableView extends LinearLayout {
    ...
    private void getAttrs(AttributeSet attrs) {
        ...
        int highlightTypeValue = a.getInteger(TimetableView_header_highlight_type,0);
    ...
    private RelativeLayout.LayoutParams createStickerParam(Schedule schedule) {
        ...
        param.setMargins(0 , calStickerTopPxByTime(schedule.getStartTime()), sideCellWidth+ cell_w * schedule.getDay(), 0);
    ...
    private int calCellWidth(){
        ...
        int cell_w = (size.x-getPaddingRight() - getPaddingLeft()- sideCellWidth) / (columnCount - 1);
        return cell_w;
    }
